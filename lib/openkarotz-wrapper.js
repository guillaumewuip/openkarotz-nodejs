...
var openKarotz = function(ip) {
    ...
    this.fixedLed = function(color, callback) {
        openKarotz.led(color, null, false, true, null, callback);
    };
    ...
    this.pulsedLed = function(color, period, callback) {
        openKarotz.led(color, null, true, true, period, callback);
    };
    ...
    this.fade = function(colorStart, colorEnd, time, callback) {
        ...
        openKarotz.led(colorStart, colorEnd, true, true, time, null);

        setTimeout(function(){
            openKarotz.fixedLed(colorEnd, callback);
        }, time);
